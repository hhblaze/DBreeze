...
namespace DBreeze.Transactions
{
    ...
    public partial class Transaction:IDisposable
    {
        ...
        public TIdentity ObjectGetNewIdentity<TIdentity>(string tableName, byte[] addressOfIdentity = null, uint seed = 1)
        {
            ...
            byte[] btcnt = this.RandomKeySorter.TryGetValueByKey(tableName, addressOfIdentity);
        ...
        public DBreeze.Objects.DBreezeObjectInsertResult<TObject> ObjectInsert<TObject>(string tableName, DBreeze.Objects.DBreezeObject<TObject> toInsert, bool speedUpdate = false)
        {
            ...
            var ptrExistingInRandom = this.RandomKeySorter.TryGetValueByKey(tableName, primary.IndexFull);
        ...
        public void ObjectRemove(string tableName, byte[] index, bool speedUpdate = false)
        {
            ...
            //In case when in one transaction one primary index was inserted several times, we need to clear up RandomKeySorter existing value
            var ptrExistingInRandom = this.RandomKeySorter.TryGetValueByKey(tableName, index);
        ...
        {
            return MultiSelectForwardFromToNet8<TKey, TValue>(tables, startKey, includeStartKey, stopKey, includeStopKey, AsReadVisibilityScope);
        }
        ...
        {
            return MultiSelectBackwardFromToNet8<TKey, TValue>(tables, startKey, includeStartKey, stopKey, includeStopKey, AsReadVisibilityScope);
        }
