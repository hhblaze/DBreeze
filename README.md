...
=====================
![Image of Build](https://img.shields.io/badge/DBreeze%20build-1.132%20production-9933FF.svg) 
...
- <a href = 'https://github.com/hhblaze/DBreeze/blob/master/Documentation/LLM/DBreeze4LLM_003_compressed.md'  target='_blank'>LLM Agents Documentation compressed (markdown, actual. 6K tokens)</a> 
