...
.NET 3.5> / Xamarin MONO Android iOS / .NET Core / Universal Windows Platform / .NET Portable . Written in C# 
...
- <a href='https://github.com/hhblaze/DBreeze/blob/master/Documentation/_DBreeze.Documentation.actual.pdf' target="_blank">Documentation (PDF, actual)</a>
