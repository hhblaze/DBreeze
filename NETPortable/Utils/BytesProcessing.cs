...
namespace DBreeze.Utils
{
    public static class BytesProcessing
    {
        ...
        public static string From_FixedSizeColumn(this byte[] value, bool isASCII)
        {
            ...
            var bt = value.Substring(2, (int)size);

            if (isASCII)
            {
                return bt.Ascii_GetString(); //System.Text.Encoding.UTF8.GetString(bt, 0, bt.Length);
                //return System.Text.Encoding.ASCII.GetString(value.Substring(2, (int)size));
            }
            else
            {
                return bt.UTF8_GetString(); //System.Text.Encoding.UTF8.GetString(bt, 0, bt.Length);
        ...
        {
            return (dBytes == null) ? String.Empty : dBytes.UTF8_GetString(); // System.Text.Encoding.UTF8.GetString(dBytes,0, dBytes.Length);
        ...
        {
            return (dBytes == null) ? String.Empty : dBytes.UTF8_GetString(); // System.Text.Encoding.Unicode.GetString(dBytes, 0, dBytes.Length);
        }
