...
namespace Deployer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var tr = Deployer2.Resource1.templ.Split(new char[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries);
            ...
            using (ZipArchive archive = ZipFile.Open(MyPath + @"..\Nuget\Actual\DBreeze.actual.nupkg", ZipArchiveMode.Update))
            {
                ...
                archive.CreateEntryFromFile(MyPath + "NET6_0" + @"\DBreeze.dll", "lib/net5.0/DBreeze.dll", CompressionLevel.Optimal);
                archive.CreateEntryFromFile(MyPath + "NET6_0" + @"\DBreeze.XML", "lib/net5.0/DBreeze.XML", CompressionLevel.Optimal);
            ...
            Utils.ConsolePrint("Done...", ConsoleColor.Green);
